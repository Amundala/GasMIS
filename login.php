  ...
  <div class="unix-login">
    <div class="container-fluid">
      <div class="row justify-content-center align-items-center">
        <div class="col-lg-4 shadow-lg p-4 my-3">
          <div class="login-content py-3">
            <div class="login-form">
              <h1 class="text-center mb-4">Merez Gas MIS</h1>
              <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" id="loginForm">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="password" id="password" name="password" class="form-control rounded-0" placeholder="Password" required="">
                    <div class="input-group-append">
                ...
                <button type="submit" name="login" class="f-w-600 btn btn-white btn-flat m-b-30 m-t-30 d-block mx-auto" style="background-color: #0F9D58; color: white; width: 100%;">Sign in</button>
              </form>
            </div>
          </div>
        </div>
