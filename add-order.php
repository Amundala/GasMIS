...
<option value="0">- Select -</option></select>  -->
        ...
        <div class="form-group">
          <div class="row">
            <label for="vat" class="col-sm-2 control-label gst">Tax Rate 18%</label>
            <div class="col-sm-4">
        ...
        <div class="form-group">
          <div class="row">
            ...
            <label for="clientContact" class="col-sm-2 control-label">Country</label>
            <div class="col-sm-4">
...
<script>
  ...
  function getTotal(row) {
    ...
    if (isNaN(rate) || isNaN(quantity)) {
      alert('Please enter valid numbers in the rate and quantity fields');
      return;
    }
