...
$sql = "SELECT * FROM orders LEFT JOIN tbl_client ON orders.client_name = tbl_client.id WHERE order_status = 1 AND user_id = '$user'";
...
<td>
   <!-- <a href="addmeasurement.php?id=<?php //echo $row['order_id']?>"><button type="button" class="btn btn-xs btn-primary" title="Add Measurement" ><i class="fa fa-plus"></i></button></a> -->
    <a href="editorder.php?id=<?php echo $row['order_id']?>">
   
  <button type="button" class="btn btn-sm btn-outline-info">
                                                <i class="fa fa-pencil"></i> Edit
                                            </button>
  </a>
  <!-- <a href="print.php?id=<?php //echo $row['order_id']?>">
  <button type="button" class="btn btn-xs btn-primary" ><i class="fa fa-print"></i>
</button>
<button type="button" class="btn btn-sm btn-outline-info">
                                                <i class="fa fa-pencil"></i> Edit
                                            </button>
...
<a href="php_action/removeOrder.php?id=<?php echo $row['order_id']?>" >

<button type="button" class="btn btn-sm btn-outline-danger" onclick="return confirm('Are you sure to delete this record?')">
