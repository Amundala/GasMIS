...
$sql = "SELECT categories_id, categories_name, categories_active, categories_status FROM categories WHERE categories_status = 1 ORDER BY created DESC";
                    ...
                    <table id="myTable" class="table table-borderless">
                        <thead style="background-color: #0F9D58;">
                            <tr>
                                ...
                                <th style="color: white;">Categories Name</th>
