     ...
     <div class="scroll-sidebar">
         ...
         <nav class="sidebar-nav">
             <ul id="sidebarnav">
                 ...
                 <?php } ?>
                 <?php if (isset($_SESSION['userId']) && $_SESSION['userId'] == 1) { ?>
                     <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-arrow-compress-all"></i><span class="hide-menu">Manage Clients</span></a>
                         <ul aria-expanded="false" class="collapse">

                             <li><a href="new_connection.php">All Clients </a></li>

                             <li><a href="onhold_connection.php">On Hold Clients </a></li>
                             <li><a href="approved_connection.php">Approved Clients </a></li>
                             <li><a href="rejected_connection.php">Rejected Clients </a></li>
